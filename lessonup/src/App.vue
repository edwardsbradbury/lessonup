<template>
  <div id="app">
    ...
    <footer>
      <!-- footer made using flexbox with one ampty div just to align it in space correctly  -->
      <div class="flex-container">
        <div>
          <h6 style="color: black;"> {{newsletter}}  </h6>
          <input type="text" id="Email" name="Email" :placeholder="placeholder" class="newsletter" >
          <input type="submit" :value="subscribe" class="newsletter" style="background:#62D2E4">
        </div>
        <div> <img id="bookLogo" src="./assets/book.png" alt=" Lesson Up logo">
        </div>
      </div> 
...
export default {
  ...
  data() {
    return {
      newsletter: "JOIN OUR NEWSLETTER TO LEARN MORE ABOUT US AND GET UPDATES ABOUT NEW APP FEATURES",
      subscribe: "SUBSCRIBE",
...
#current:hover {
  color: #04e4b9;
  border-bottom: 0.5vh solid #04e4b9;
}
